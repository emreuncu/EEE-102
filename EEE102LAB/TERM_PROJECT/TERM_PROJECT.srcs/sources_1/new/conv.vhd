...
d: entity work.bin_to_bcd port map(res(14 downto 12) & res(10 downto 8) & res(6 downto 4) & res(2 downto 0),bcd1);
    process
    begin
        if enable = "0111" then     -- H to O
            coder <= "0" & res(11 downto 9) & "0" & res(8 downto 6) & "0" & res(5 downto 3) & "0" & res(2 downto 0);
        elsif enable = "1000" then  -- H to D
            coder <= bcd;
        elsif enable = "1001" then  -- O to H
            coder <= "0000" & res(14 downto 12) & res(10 downto 8) & res(6 downto 4) & res(2 downto 0);
        elsif enable = "1010" then  -- O to D
            coder <= bcd1;
        elsif enable = "1011" then  -- D to H
            coder <= "0000" & bin(11 downto 0);
        elsif enable = "1100" then  -- D to O
            coder <= "0" & bin(11 downto 9) & "0" & bin(8 downto 6) & "0" & bin(5 downto 3) & "0" & bin(2 downto 0);
        end if;
    end process;                       
